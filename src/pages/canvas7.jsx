...
export default function FlowPage() {
  const initialNodes = [
    {
      id: "1",
      position: { x: 0, y: 0 },
      data: { label: "Start", info: "entry point", args: ["Hello world"] },
      type: "input",
    },
    {
      id: "2",
      position: { x: 200, y: 100 },
      data: { label: "🌐 Fetch Data", info: "gets info from API", args: [] },
    },
    {
      id: "3",
      position: { x: 400, y: 0 },
  ...
  // Inject custom label rendering into nodes
